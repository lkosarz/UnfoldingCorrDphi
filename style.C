...
{// Add my own options here:
  ...
  myStyle->SetLabelSize(0.054,"xyz"); // size of axis value font
  myStyle->SetTitleSize(0.062,"xz"); // size of axis title font
  myStyle->SetTitleSize(0.062,"y"); // size of axis title font
